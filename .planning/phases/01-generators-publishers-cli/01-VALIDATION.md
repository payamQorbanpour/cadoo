...
**Approval:** approved (plan-level Nyquist contract verified by gsd-plan-checker; `wave_0_complete` flips true once the Wave-0 test files are created during execution)
